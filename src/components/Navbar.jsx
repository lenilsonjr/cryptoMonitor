...
class Navbar extends Component {
  ...
  handleData(data) {
    ...
    if (data['PRICE'] !== undefined ) {
      ...
      let BTCPrice = data['PRICE'].toFixed(0);
      let BTCIcon = 'glyphicon glyphicon-minus';      
      if ( data['FLAGS'] === '1' ) {
        BTCIcon = 'glyphicon glyphicon-chevron-up';
      } else if ( data['FLAGS'] === '2' ) {
        BTCIcon = 'glyphicon glyphicon-chevron-down';
      }

      this.setState({ BTCIcon, BTCPrice });
    }
      ...
      <nav className="navbar navbar-inverse">
        <div className="container-fluid">
          ...
          <div id="navbar" className="navbar-collapse collapse">
            <p className="navbar-text pull-right text-center btc-price">
              BTC: <span className={ this.state.BTCIcon }></span> ${ this.state.BTCPrice }
            </p>

            <p className="navbar-text navbar-right">
              <a href="https://github.com/lenilsonjr/cryptoMonitor" className="github-corner" aria-label="View source on Github">
